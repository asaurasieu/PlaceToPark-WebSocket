...
stream_url = "https://manifest.googlevideo.com/api/manifest/hls_variant/expire/1725139684/ei/hDbTZqq6IfWDp-oPl-a2sQg/ip/81.34.22.127/id/EPKWu223XEg.4/source/yt_live_broadcast/requiressl/yes/xpc/EgVo2aDSNQ%3D%3D/hfr/1/playlist_duration/30/manifest_duration/30/maudio/1/spc/Mv1m9vfDbZiWiH2B4Ngvcoqyz185l_XA6jeBbUQh37vEEKTRVQSjLNLI-tGnTy0/vprv/1/go/1/rqh/5/pacing/0/nvgoi/1/keepalive/yes/dover/11/itag/0/playlist_type/DVR/sparams/expire%2Cei%2Cip%2Cid%2Csource%2Crequiressl%2Cxpc%2Chfr%2Cplaylist_duration%2Cmanifest_duration%2Cmaudio%2Cspc%2Cvprv%2Cgo%2Crqh%2Citag%2Cplaylist_type/sig/AJfQdSswRgIhANuuAF8JW9iUFDSGaOKHNkk1bRcaBw66FAoiB1OFZVsXAiEA6lkHbg-2igXDFRbSDmYpMrzxpyZlYsVrcmTyza9EBgU%3D/file/index.m3u8"
...
try:
    while True:
        ...
        # Get all frames in the output directory and upload them
        frames = glob.glob(f"{output_dir}/frame_*.jpg")
        for frame in frames:
            upload_frame_to_server(frame)
            os.remove(frame)  # Remove the frame after uploading
